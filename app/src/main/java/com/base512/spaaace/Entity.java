...
public class Entity implements Comparable<Entity> {
	...
	private void setVars(String name, int x, int y, int depth) {
		...
		//Log.i("Spaaace", "Entity constructor: " + name + " (" + this.width + "x" + this.height + ")");
	}
	...
	public void draw(Screen screen, int frame) {
		//Log.d("Spaaace", "Entity: draw " + name + " " + frame + "/" + (shape.length - 1));
		int x = (int)fx;
		int y = (int)fy;
		...
		for (int lineNum = 0; lineNum < height; lineNum++) {
			...
			/* Log.d("Spaaace", "Entity: draw start=" + start + " end=" + end +
					" line=" + yy + " col=" + x); */
		...
		//Log.d("Spaaace", "Entity: draw complete");
	}
	...
	public void move() {		
        ...
        //Log.d("Spaaace", name + " frame = " + frame);
	}
